...
public class AddQuestActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void addQuest(View button){
        ...
        // Prüfen auf aufgefüllte Feldern (Name des Questes und Exp)
        if (quest_name.getText().toString().equals("") || quest_exp.getText().toString().equals("")){
            Context context = this;
            CharSequence text = "Fehlerhafte Angabe!";
